...
set /p folderlocation="Where do you want to create the folder? (Example: C:\Users\%username%\Desktop) "
set /p foldername="What do you want the folder to be called? "
md "!folderlocation!\!foldername!"
cd "!folderlocation!\!foldername!"

set /p memvalue="How much memory do you want to allocate? (In MB): "
...
if !launcher! == 1 (
    ...
    set /p vanillaversion=What version do you want to install? (Example: 1.17.1) 
...
if !launcher! == 2 (
    ...
    set /p mohistversion=What version do you want to install? (Example: 1.12.2) 
...
if !launcher! == 3 (
    ...
    set /p fabricversion=What version do you want to install? (Example: 1.17.1) 
...
if !launcher! == 4 (
    ...
    set /p forgeversion=What version do you want to install? (Example: 1.12.2) 
    ...
    START "" start.bat
    echo Installing Forge and setting everything up. Wait 60 seconds...
    timeout /t 60 > nul
    if exist "run.bat" (
    call run.bat
    ) else (
    for /f "delims=" %%F in ('dir /b minecraft_server*') do (
        call "%%F"'
        exit /b
    )
    )
